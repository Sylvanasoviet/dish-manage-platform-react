...
interface ListSearchProjectsProps extends FormComponentProps {
  ...
  listAndListSearchProjects: StateType;
  loading: boolean;
}
...
class ListSearchProjects extends Component<ListSearchProjectsProps> {
  componentDidMount() {
    ...
    dispatch({
      type: 'listAndListSearchProjects/fetch',
      payload: {
        count: 8,
      },
    });
  ...
  render() {
    const {
      listAndListSearchProjects: { list = [] },
      loading,
      form,
    } = this.props;
...
export default connect(
  ({
    ...
    listAndListSearchProjects,
    loading: loading.models.listAndListSearchProjects,
  }),
)(WarpForm);
